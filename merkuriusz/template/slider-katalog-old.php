			...
			<div class="sliderpop-container row">
				<a href="" target="_blank">
					<div class="sliderpop-element">
						<img class="sliderpop-image" src="<?php echo get_template_directory_uri(); ?>/img/partnerzy/jhk.svg">
					</div>
				</a>
				<a href="http://poligon.scepter.pl/PiotrM/wp_merkuriusz/wp-content/uploads/2017/08/adler-katalog-2017-PL.pdf" target="_blank">
					<div class="sliderpop-element">
						<img class="sliderpop-image" src="<?php echo get_template_directory_uri(); ?>/img/partnerzy/logo_adler.svg">
					</div>
				</a>
	...
	<div class="popup">
		...
		<div class="popup-content">
			<div class="sliderpop-container row">
				...
				<a href="http://poligon.scepter.pl/PiotrM/wp_merkuriusz/wp-content/uploads/2017/08/KATALOG-TORBY-strona-internetowa.pdf" target="_blank"><div class="sliderpop-element">Torby papierowe</div></a>
			</div>
		</div>
	</div>
</div>
		...
		<div class="catalog-container">
			<?php
				...
				<div class="catalog-element">
					...
					<div class="catalog_signature">Długopisy plastikowe</div>
					<a class='hitbox' href=''></a>
				</div>
				*/
